...
const DATA: Item[] = [
  { id: 'exp-1', kind: 'experience', title: 'Data Co-Op, Tools & Tech', org: 'Delta', period: 'Sep 2023 - May 2025', tags: ['AWS', 'Lake Formation', 'Analytics'], blurb: 'Architected AWS data pipelines and dashboards for multi-TB datasets.', href: 'www.delta.com' },
